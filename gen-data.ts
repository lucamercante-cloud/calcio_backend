...
import { ClubsModel } from './src/api/Club/club.model.js';
import { CategoryModel } from './src/api/Category/category.model.js';
import { PlayersModel } from './src/api/Players/players.model.js';
import { NewsModel } from './src/api/Notizie/notizie.model.js';
import { SponsorModel } from './src/api/Sponsor/sponsor.model.js';
import { OrganigrammaModel } from './src/api/Organigramma/organigramma.model.js';
...
async function seedDatabase() {
  try {
    ...
    await OrganigrammaModel.create([
      {
        nome: 'Giuseppe',
        cognome: 'Colombo',
